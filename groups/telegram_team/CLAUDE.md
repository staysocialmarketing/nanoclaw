...
This shared memory is also visible to Lev in the personal chat context, so both contexts stay aligned.
...
- Create files in `/workspace/group/` for drafts, campaign work, and context specific to this group
